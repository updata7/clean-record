...
- 📹 **区域录制** - 自由选择录制区域，**录制过程中支持实时移动区域位置**
- 🖥️ **全屏录制** - 一键录制整个屏幕
- 📸 **区域截图** - 快速截取屏幕区域
- 🎥 **摄像头叠加** - 支持摄像头画中画，采用 **macOS 原生丝滑拖拽机制**
- 🎨 **Excalidraw 协作白板** - **内置纯净版 Excalidraw 面板，支持实时板书、打字与标注，录屏结束自动关闭**
- 📱 **多比例支持** - 预设 16:9, 4:3, 1:1 以及 **9:16 (抖音/TikTok/小红书竖屏神器)** 等常用比例
- 🎙️ **麦克风录音** - 可选麦克风音频录制
- 🌍 **国际化支持** - 支持中文和英文界面
- ⏸️ **暂停/继续** - 录制过程中可暂停和继续
- 💄 **美颜滤镜** - 摄像头支持实时美颜效果
...
- `⌥⇧2` - 录制区域 (Record Area)
- `⌥⇧1` - 录制全屏 (Record Fullscreen)
- `⌥⇧S` - 停止录制 (Stop Recording)
